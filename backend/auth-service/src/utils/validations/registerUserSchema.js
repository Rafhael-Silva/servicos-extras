...
const registerUserSchema = joi.object({
  ...
  cpf: joi.alternatives().conditional('accountType', {
    ...
    then: joi
      ...
      .required()
      .messages({
        'any.required': 'CPF é obrigatório para pessoas físicas.',
        'string.empty': 'CPF não pode estar vazio para pessoas físicas.',
  ...
  cnpj: joi.alternatives().conditional('accountType', {
    ...
    then: joi
      ...
      .required()
      .messages({
        'any.required': 'CNPJ é obrigatório para empresas.',
        'string.empty': 'CNPJ não pode estar vazio para empresas.',
        'string.pattern.base': 'O CNPJ deve ter exatamente 14 números.',
      }),
    otherwise: joi.forbidden().messages({
